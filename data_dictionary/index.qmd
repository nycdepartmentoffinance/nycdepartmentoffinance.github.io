...
-   [Building Classifications](building_classifications.html): A table that contains all building classifications with their tax class, description, use and relevant model codes.
...
-   [Model Codes](model_codes.html): A table that maps the Vision model codes to the specific property types.
...
To download any of these data sets, visit the source data [here](https://github.com/nycdepartmentoffinance/nycdepartmentoffinance.github.io/tree/main/data_dictionary/data).
